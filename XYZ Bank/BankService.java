...
public class BankService {
    ...
    public static void signUp() {
        ...
        Bank.balanceList.put(numberGenerating.debitCardNumber, minBalance);
        Bank.creditDebitAccount.put(numberGenerating.debitCardNumber, numberGenerating.debitPinNumber);
        if (wantCreditCard.equals("Y") || wantCreditCard.equals("y")) {
            ...
            Bank.balanceList.put(numberGenerating.creditCardNumber, minBalance);
            Bank.creditDebitAccount.put(numberGenerating.creditCardNumber, numberGenerating.creditPinNumber);
        }
    ...
    public static void visitShop() {
        ...
        Account account1 = new Account(user1, 12345, 100., "Ram");
        Bank.creditDebitAccount.put(111,1);
        Bank.creditDebitAccount.put(100,1);
        ...
        Bank.balanceList.put(100, 600.);
        Bank.balanceList.put(200, 100.);
        Bank.balanceList.put(111,600.);
        Bank.balanceList.put(222,500.);
    ...
    public static void credit(int cardNumber, double creditBalance) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 5: {
                    System.out.println("Logout Successfully!!!");
                    Bank.balanceList.put(cardNumber,creditBalance);
                    break Inner;
                }
                default:
    ...
    public static void debit(int cardNumber) {
        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 5: {
                    System.out.println("Logout Successfully!!!");
                    Bank.balanceList.put(cardNumber,Bank.balanceList.get(cardNumber));
                    break Inner;
                }
                default:
                    System.out.println("Invalid Option!!!");
