...
public class Generating{
        ...
        {
        while (!(bank.getDebitCredentials().containsKey(debitCardNumber))&&!(debitCardNumberString.length() == 9)) {
                int min = 100000000;
                int max = 999999999;
        ...
        {
        while(!(bank.getCreditCredentials().containsKey(creditCardNumber))&&!(creditCardNumberString.length() == 9)){
                int min = 100000000;
                int max = 999999999;
