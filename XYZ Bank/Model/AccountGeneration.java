...
public class AccountGeneration {
        ...
        {
        while (!(bank.getDebitAccount().containsKey(debitCardNumber))&&!(debitCardNumberString.length() == 9)) {
                int min = 100000000;
                int max = 999999999;
        ...
        {
        while(!(bank.getCreditAccount().containsKey(creditCardNumber))&&!(creditCardNumberString.length() == 9)){
                int min = 100000000;
                int max = 999999999;
